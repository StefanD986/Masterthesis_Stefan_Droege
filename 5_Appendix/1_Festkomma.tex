...
\FGimg[Beispiel Festkommakonvertierung positive Zahl]{FixkommaBsp1Positiv.png}{Beispiel für eine Umwandlung einer positiven Fließkommazahl zur Basis 10 in eine Festkommazahl zur Basis 2.}{0.65\textwidth}

\FGimg[Beispiel Festkommakonvertierung negative Zahl]{FixkommaBsp2Negativ.png}{Beispiel für eine Umwandlung einer negativen Fließkommazahl zur Basis 10 in eine Festkommazahl zur Basis 2. Negative Zahlen werden als ihr Zweierkomplement dargestellt, bei der das MSB die Wertigkeit $-2^m$ hat.}{0.65\textwidth}
