...
\FGimg[Entity/Architecture des Code NCO]{UML_class_code_nco.pdf}{Entity und Architecture und darin definierte Typen welche die Steuersignale für den Code Kopie Generator erzeugt.}{7cm}
...
\FGimg[Tracking Loop Package]{UML_class_tracking_loop_pkg.pdf}{Weitere Datentypen die im Package \lstinline$tracking_loop_pkg$ definiert sind.}{8cm}
