...
\newcommand{\gpsTbit}{{T}_{bit}} % (time)length of one code chip
\newcommand{\gpsftcxo}{f_{TCXO}} % frequency of TCXO
\newcommand{\gpsfcarr}{f_{L1}} % L1 Carrier Frequency
\newcommand{\gpsfchip}{f_{Chip}} % Chippingrate
