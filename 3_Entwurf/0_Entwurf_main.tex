...
\subsection{Benötigte Daten für Acquisition und Positionsbestimmung}
Die Acquisition benötigt den oben genannten Umfang an Rohdaten. Die Acquisition Ergebnisse beziehen sich außerdem immer auf die Rohdaten und damit auf einen bestimmten Zeitpunkt. Für die Acquisition selbst ist der Zeitpunkt nicht wichtig, aber beim Initialisieren der Trackingloops wird die Information benötigt, und muss daher irgendwo festgehalten werden. 

Für die Positionsbestimmung werden zunächst einmal die NAV Daten benötigt. Die NAV Daten der einzelnen Kanäle müssen dabei zeitlich synchronisiert sein, damit die relative Zeitinformation erhalten bleibt. Außerdem wurde unter \ref{positionsbestimmung} bereits erklärt, dass zur Berechnung der Pseudoranges auch die Codephase ausgewertet werden muss. Deshalb sollen die Trackingkanäle auch die zu den NAV Daten synchronisierten Codephasen bereitstellen.
