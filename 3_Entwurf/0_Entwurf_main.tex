...
Die Charakteristik des Code Phasen Diskriminators wurde bereits in \FR{CodeDiskriminatorCharacteristic.png} dargestellt. Daraus lässt sich ablesen, dass $K_{d,code}=-\frac{2}{\Delta t}$ ist, mit $\Delta t$ der zeitlichen Differenz der Code Kopien zum pünktlichen Code. 
