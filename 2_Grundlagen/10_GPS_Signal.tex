...
\FGimg[Goldcode erzeugung mittels LFSR]{LFSRGoldcode.png}{Erzeugung der Goldcode Folgen durch punktweiser Modulo-2 Addition (\emph{XOR}) zweier Maximum Length Sequences die jeweils durch ein \gls{LFSR} erzeugt werden. Die Abgriffe die bei der Addition verwendet werden sind Abhängig von der \gls{PRN}}{.9\textwidth}
