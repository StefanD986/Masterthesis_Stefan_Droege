...
Die Positionsbestimmung mittles GPS erfolgt nach dem Prinzip der \emph{Lateration}: Wenn der Beobachter die Entfernung zu einem Punkt kennt, so muss er sich an einem Punkt auf einer Kugelfläche um diesen Punkt befinden. Wenn der Beobachter die Entfernung zu einem Zweiten Punkt kennt, muss sich die 