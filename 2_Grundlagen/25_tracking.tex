...
Der im Blockschaltbild (\FR{EarlyLateBlockdiagram.png}) verwendete einfache Code Loop Diskriminator (\phi_g=) hat den Nachteil, dass er einen von der Signalstärke, Codelänge, und Abtastrate abhängigen Ausgangswert erzeugt \cite{borre2007software}. Deshalb wird in dieser Arbeit ein Diskriminator verwendet, der einen normalisierten Ausgangswert erzeugt:
\begin{equation}
