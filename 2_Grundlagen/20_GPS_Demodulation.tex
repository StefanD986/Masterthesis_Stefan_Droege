...
\FGimg[Blockschaltbild parallele Frequenzsuche]{parallelfreqspace.png}{Bei der parallelen Frequenzbereichsuche müssen nur die möglichen Codephasen seriell durchsucht werden. Die Bestimmung der Dopplerverschiebung erfolgt durch eine Maximumsuche im Frequenzbereich.}{0.6\textwidth}
