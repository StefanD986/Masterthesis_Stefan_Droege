...
\FGimg[Timingdiagramm EBIU Asynchronous Read Write]{EBIU_readwrite.pdf}{Timing der Signale der EBIU Schnittstelle für einen asynchronen Schreib- bzw. Lesevorgang. Der Takt ist auf Clientseite nicht unbedingt benötigt. Nicht alle Steuersignale sind auf dem \comboard an den FPGA geführt. (entnommen aus \cite{BlackfinHWReference}, S. 7-14)}{0.98\textwidth}
