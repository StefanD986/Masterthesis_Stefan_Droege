...
\FGimg{LinuxSystem.png}{Prinzipielle Systemarchtiektur eines Linux Systems. Die Hardware wird durch den Kernel und die Kerneltreiber abstrahiert}{0.6\textwidth}
