...
\FGimg{parallelfreqspace.png}{Bei der parallelen Frequenzbereichsuche müssen nur die möglichen Codephasen seriell durchsucht werden. Die Bestimmung der Dopplerverschiebung erfolgt durch eine Maximumsuche im Frequenzbereich. In dieser Arbeit wird die parallele Frequenzsuche nach einer ersten parallelen Codephasensuche eingesetzt um die Dopplerverschiebung genauer zu bestimmen.}{0.6\textwidth}
