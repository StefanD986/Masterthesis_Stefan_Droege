...
%\newcommand{\FG}[3]{										% Makro zum einfachen Einbinden von Bildern
%	\vspace{2mm}											%\FG{RAR.jpg}{100mm}{Freifeldraum}  Bsp.
%	\begin{figure}[htbp]
%		\begin{center}
%		\includegraphics[width=#2]{#1} \\[1mm]
...
\newcommand{\ThesisTitle}{Entwicklung eines Software Defined GNSS Empfängers für den Dragsail-Cubesat}
